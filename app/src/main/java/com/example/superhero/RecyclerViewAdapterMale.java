...
public class RecyclerViewAdapterMale extends RecyclerView.Adapter<RecyclerViewAdapterMale.RecyclerViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapterMale(ArrayList<basic> courseDataArrayList, Context mcontext) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        if(modal.getAppearance().getGender().equals("Male")) {
