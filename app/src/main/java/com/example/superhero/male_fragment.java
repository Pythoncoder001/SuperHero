...
public class male_fragment extends Fragment   {
    ...
    private RecyclerViewAdapterMale recyclerViewAdapterMale;
    private ProgressBar progressBar;

    @Override
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.heroes_list_male);
        progressBar = view.findViewById(R.id.progress_bar_male);
            ...
            public void onResponse(Call<ArrayList<basic>> call, Response<ArrayList<basic>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < Objects.requireNonNull(recyclerDataArrayList).size(); i++) {
                        recyclerViewAdapterMale = new RecyclerViewAdapterMale   (recyclerDataArrayList,getContext());
                        ...
                        recyclerView.setAdapter(recyclerViewAdapterMale);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_male_fragment2,container,false);
    }
